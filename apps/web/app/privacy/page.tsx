    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="space-y-4 text-sm leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            <strong>Conversations and contexts</strong> — workspace agent chat
            history and any context files you create.
          </li>
          <li>
        ...
        <p>
          ...
          conversations, and contexts can be deleted through the app or by
