          ...
          {actions.map((action) =>
            action.method === "GET" ? (
              <a
                key={action.id}
                href={action.href}
                className="inline-flex items-center gap-1 rounded-md bg-muted/60 px-2 py-1 text-[11px] font-medium text-foreground hover:bg-muted transition-colors"
              >
              ...
              <span
                key={action.id}
                className="inline-flex items-center rounded-md bg-muted/40 px-2 py-1 text-[11px] text-muted-foreground"
              >
                {action.label ?? action.id}
