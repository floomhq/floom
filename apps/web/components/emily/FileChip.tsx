...
export function FileChip({
  ...
  return (
    <div className="inline-flex items-center gap-1.5 rounded-[var(--radius-ui)] bg-muted/60 pl-2.5 pr-1.5 py-1 text-xs max-w-[200px]">
      ...
      {onRemove && (
        <button
          type="button"
          onClick={onRemove}
          className="shrink-0 rounded-[var(--radius-ui)] p-0.5 hover:bg-muted transition-colors text-muted-foreground hover:text-foreground"
