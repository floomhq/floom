...
const TOOL_GROUPS: { group: string; tools: { name: string; description: string }[] }[] = [
  ...
  {
    group: "Library (Contexts)",
    tools: [
      { name: "contexts.list", description: "List library folders." },
      { name: "contexts.create", description: "Create a new library context." },
      { name: "contexts.delete", description: "Delete a library folder and all its files." },
      { name: "contexts.read", description: "Read a file from a library folder." },
      { name: "contexts.write", description: "Create or update a file in a library folder." },
      { name: "contexts.upload", description: "Upload a binary file to a library folder." },
      { name: "contexts.delete_file", description: "Delete a specific file from a library folder." },
      { name: "contexts.versions", description: "List saved versions of a library folder." },
      { name: "contexts.rollback", description: "Restore a library folder to a previous version." },
    ],
  },
  {
