    ...
    <div className={cn("flex flex-wrap items-center gap-1.5", className)}>
      ...
      {visible.map((it) => {
        ...
        return (
          <span
            key={it.id}
            className="inline-flex items-center gap-1.5 rounded-[var(--radius-pill)] border border-[var(--border-default)] bg-[var(--bg-2)] py-0.5 pl-2 pr-1.5 text-xs text-foreground"
          >
            {it.brand ? (
