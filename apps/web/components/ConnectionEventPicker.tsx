  ...
  if (connectedApps.length === 0) {
    return (
      <div className="rounded-[var(--radius-ui)] bg-muted/30 p-3 space-y-2">
        ...
        <Link href="/connections/browse" className="inline-flex items-center gap-1 rounded-[var(--radius-ui)] bg-card px-2 py-1 text-xs hover:bg-muted">
        ...
        <div className="space-y-1.5">
          ...
          {loadingTriggers ? (
            <div className="space-y-1.5 py-1" aria-label={`Loading ${appDisplayName(selectedApp)} events`}>
              <div className="h-8 rounded-[var(--radius-ui)] bg-muted/50" />
