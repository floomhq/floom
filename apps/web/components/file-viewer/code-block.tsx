...
export function CodeBlock({
  ...
  const surfaceClass =
    surface === "flat"
      ...
      : surface === "code"
        ? "bg-[var(--code-panel-bg)] dark:bg-[var(--code-panel-bg)]"
  ...
  return (
    <div className="p-0">
      <pre className={`max-w-full overflow-auto rounded-[var(--radius-ui)] p-3 font-mono text-xs leading-6 text-foreground ${surfaceClass}`}>
        {highlighted ? (
          <code
