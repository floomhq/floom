...
const buttonVariants = cva(
  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-[var(--radius-ui)] bg-clip-padding text-sm font-medium whitespace-nowrap shadow-none transition-all duration-150 ease-[var(--ease)] outline-none select-none active:not-aria-[haspopup]:translate-y-px active:not-aria-[haspopup]:scale-[0.985] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        xs: "h-6 gap-1 rounded-[var(--radius-ui)] px-2 text-xs in-data-[slot=button-group]:rounded-[var(--radius-ui)] has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
        sm: "h-7 gap-1 rounded-[var(--radius-ui)] px-2.5 text-[0.8rem] in-data-[slot=button-group]:rounded-[var(--radius-ui)] has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
        lg: "h-9 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
        icon: "size-8",
        "icon-xs":
          "size-6 rounded-[var(--radius-ui)] in-data-[slot=button-group]:rounded-[var(--radius-ui)] [&_svg:not([class*='size-'])]:size-3",
        "icon-sm":
          "size-7 rounded-[var(--radius-ui)] in-data-[slot=button-group]:rounded-[var(--radius-ui)]",
        "icon-lg": "size-9",
      },
    },
    defaultVariants: {
