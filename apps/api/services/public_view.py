...
def _redact_public_log_message(message: str) -> str:
    ...
    # (/opt/floom/...) and sandbox paths (/home/user/worker/run.py),
...
def _public_artifact_path(raw_path: Optional[str]) -> str:
    ...
    (e.g. /opt/floom/data/artifacts/run_x/out/sorted.csv). Returning it
...
def _run_error_raw(
    ...
    # (sandbox /home/user/worker/, server /opt/floom/...). error_raw must
