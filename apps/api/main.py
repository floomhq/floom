...
# #997 security: NEVER auto-load a cwd .env unless the developer explicitly opts
# in. Production and CI supply env via the orchestrator; an ambient .env in cwd
# can otherwise inject stale config or attacker-controlled secrets at import.
