...
export const TEMPLATES: Template[] = [
  {
    ...
    triggers: ["Calendar event", "Slack request"],
  },
  {
    ...
    output: "Slack post + 1-page report",
    runs: "Every Monday at 9am",
    tools: ["Sheets", "Linear", "Slack", "Notion"],
    approval: "Required",
  ...
  },
  {
    ...
    runs: "Slack request or new lead",
    tools: ["HubSpot", "Gmail", "Web", "Slack"],
    approval: "Required",
    approvalNote: "Required before CRM updates or outreach",
    triggers: ["Slack request", "New lead"],
  },
  {
  ...
  },
  {
    ...
    tools: ["Sheets", "Notion", "Linear", "Slack"],
    approval: "Required",
  ...
  },
  {
    ...
    runs: "Weekly schedule or Slack request",
    tools: ["Web", "Sheets", "Gmail", "Slack"],
    approval: "Required",
    approvalNote: "Required before outreach",
    triggers: ["Schedule", "Slack request"],
  },
  {
    ...
    runs: "Schedule or Slack request",
    tools: ["HubSpot", "Salesforce", "Sheets", "Slack"],
    approval: "Required",
  ...
  },
  {
    ...
    runs: "New support email or Slack request",
    tools: ["Gmail", "Intercom", "Notion", "Slack"],
    approval: "Required",
    approvalNote: "Required before sending",
    triggers: ["New email", "Slack request"],
  },
];
...
export function getTemplateDetail(t: Template): TemplateDetail {
  ...
  return {
    ...
    exampleRun: {
      id: "Run #1042",
      trigger: t.triggers[0] ?? "Slack request",
