...
// The fedes-projects workeros-cloud-dashboard project. The repo root must never
// be built INSIDE this project: a root deploy would upload the landing
// vercel.json into the dashboard project and make /app rewrite to itself. The
// dashboard is built from ./web only.
