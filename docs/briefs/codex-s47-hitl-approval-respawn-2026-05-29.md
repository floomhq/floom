# S47 — HITL via approval-page + respawn (Search Assistant requirement)

**Date:** 2026-05-29
**Author:** Claude
**Priority:** P0 — hard requirement for Search Assistant (customer #1). Recruiting workflows need a human approve/edit step before an outbound action.
