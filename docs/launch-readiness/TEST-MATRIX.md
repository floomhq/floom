...
| 10 | Agent runtime — in-process | `SKILL.md` / `.md` workers through API-process AgentDriver | manual end-to-end + security review for host-side tools and connections | ✅ done (this turn) |
| 11 | Agent execution policy | Trusted platform-controlled bundles only; policy is not a sandbox boundary | docs/security review | ✅ documented 2026-06-09 |
