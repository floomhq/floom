...
- Cloud `floomhq/workeros-cloud` PR #113
...
| `floomhq/workeros-cloud` | #113 | GO | Rebased/cherry-picked onto current Cloud main, verified, then merged. |
...
- Deployed to Railway service `workeros-cloud-api`.
- Live health:
...
- Production deploy URL: `https://workeros-cloud-dashboard-3wxqtt1eo-fedes-projects-5891bd50.vercel.app`
