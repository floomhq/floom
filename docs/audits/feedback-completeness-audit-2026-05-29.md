...
14. **"Floom v0" label bottom-left → user profile.** USR 287 ("'Floom v0' at bottom left sucks. replace. maybe with user profile? like 'local user'"). Status unverified, not in ledger. **Gap.**
...
| G-7 | "Floom v0" bottom-left → user profile | 287 | ❌ (nowhere) |
...
| API on AX41 | "api on this ax41 pls" | ab820815 | 1 | ✅ | workers-api.floom.dev live | — | — |
...
| "Floom v0" → user profile | "'Floom v0' bottom left sucks" | ab820815 | 1 | ❌ | unverified/nowhere | — | — |
