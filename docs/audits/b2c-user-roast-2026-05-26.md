...
**Where I landed:** Not a marketing page. Straight into `/` which is the **dashboard** — stats (WORKERS: 0, RUNS TODAY: 0, FAILED: 0), a sidebar with Overview / Workers / Runs / Secrets / Connections / Settings. Dark/light toggle. "Floom v0" badge.
