...
Walked every page myself via the AX41 broker. Reference bar is /runs/<id> at 88 (Federico's gold standard). Average ~71. Honest scores below; S29q has shipped the top fixes from this list.
