...
- **Method:** self-hosted server Browser Broker (desktop, pool-a) + Chrome DevTools CDP @375px (mobile), real interactions. Backend cross-checked via `/api/proxy/*` and source at `/root/workeros`.
