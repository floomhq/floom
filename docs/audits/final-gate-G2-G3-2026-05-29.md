...
**Method:** self-hosted server Browser Broker (pool-e, CDP 9227) every-click walk desktop(1280) + mobile(375 via CDP emulation); backend via `/api/proxy/*` with `.deploy-secret`.
