...
open-source project is headed. It is intentionally deployment-neutral: Floom
...
- Improve documentation and examples so new contributors can build an agent
...
- Web UI for agents, runs, connections, approvals, contexts, and settings.
...
- **Examples:** more small, real agents that demonstrate one concept each.
- **Docs:** clearer recipes for self-hosting, agent authoring, and MCP setup.
...
- Marketplace-style agent installation.
