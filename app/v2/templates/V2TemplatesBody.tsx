...
/**
 * /v2/templates — designed templates browser on the v2 system.
...
function Card({ t, i }: { t: Template; i: number }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -2 }}
      className="group flex h-full flex-col rounded-[16px] bg-card p-5 transition-shadow"
...
export function V2TemplatesBody() {
    ...
    <div className="theme-v2 min-h-screen text-[13.5px]" style={{ background: "var(--bg-app)", color: "var(--text-primary)" }}>
      <div className="mx-auto max-w-[1000px] px-7 pb-28">
        ...
        >
              ...
              <button
                ...
                style={
                  cat === c
                    ...
                    : { borderColor: "var(--border-default)", background: "var(--bg-card)", color: "var(--text-muted)" }
                }
              >
                {c}
              </button>
          ...
          <div className="ml-auto flex min-w-[200px] items-center gap-2 rounded-[10px] border border-border bg-card px-3 py-1.5">
