...
- **Cloud** branch `fix/trust-and-followups-r9` off cloud `origin/integration/final-20260617`
  (base cloud `dd01c907`). Worktree `/tmp/workeros-cloud-trust-r9`. **Final SHA `55205e09`.**
- Repos: `floomhq/workeros` (engine) + `floomhq/workeros-cloud`. NOT merged to any
  main/trunk/prod.
...
- **`fix-cloud-p0s.md` itself is not on the cloud integration base** — it lives on
  `floomhq/workeros-cloud` branch `fix/cloud-p0s-r9` @ `7ed7a6a3` (RSC-401 + create-
